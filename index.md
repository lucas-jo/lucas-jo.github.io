...
*   **Zeroth Project (SLR40)**: Led the development of the [Zeroth Project](https://github.com/goodatlas/zeroth), establishing the first **official Korean recipe** in the **Kaldi** repository. 
